...
import { goNext, setFormData, goPrev } from "../form/formSlice";
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  <TextField
                    ...
                    onBlur={formik.handleBlur}
                  />
                  {formik.touched.beneficiaryBirthday &&
                    formik.errors.beneficiaryBirthday && (
                      <span className="error">
                        {formik.errors.beneficiaryBirthday}
                      </span>
                    )}
                ...
                <Grid item xs={6}>
                  <TextField
                    ...
                    onBlur={formik.handleBlur}
                  />
                  {formik.touched.beneficiaryIdCard &&
                    formik.errors.beneficiaryIdCard && (
                      <span className="error">
                        {formik.errors.beneficiaryIdCard}
                      </span>
                    )}
